...
WebUI.setText(findTestObject('Page_Login - My ASP.NET Application/input_Email_email'), 'nghiem123@edu')

WebUI.setText(findTestObject('Page_Login - My ASP.NET Application/input_Password_password'), 'adnmin')
