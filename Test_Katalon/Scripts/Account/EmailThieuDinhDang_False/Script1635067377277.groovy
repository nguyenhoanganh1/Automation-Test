...
WebUI.setText(findTestObject('Page_Dangky - My ASP.NET Application/input_Username_id'), 'phonglinh')
...
WebUI.setText(findTestObject('Page_Dangky - My ASP.NET Application/input_Fullname_fullname'), 'longhen')

WebUI.setText(findTestObject('Page_Dangky - My ASP.NET Application/input_Email Address_email'), 'long12569')
