...
WebUI.setText(findTestObject('Page_Dangky - My ASP.NET Application/input_Username_id'), 'ha')

WebUI.setText(findTestObject('Page_Dangky - My ASP.NET Application/input_Password_password'), 'ha')

WebUI.setText(findTestObject('Page_Dangky - My ASP.NET Application/input_Confirm Password_confirm'), 'ha')

WebUI.setText(findTestObject('Page_Dangky - My ASP.NET Application/input_Fullname_fullname'), 'Hoang Anh')

WebUI.setText(findTestObject('Page_Dangky - My ASP.NET Application/input_Email Address_email'), 'HoangAnh123@gmail.com')
...
WebUI.verifyMatch(CurrentUrl, 'https://localhost:44368/', false)
